...
import top.naccl.model.dto.BlogDTO;
...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody BlogDTO blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody BlogDTO blog) {
	 ...
	 * @return
	 */
	private Result getResult(BlogDTO blog, String type) {
		//验证普通字段
